...
const PHRASE = 'Get Max Realtors · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Get Max Realtors</span><span>REALTY</span></div>
